...
> _tip_: this frontend is designed to work with `The RestAPI Backend`. It is recommended you stand up the backend first, test using Postman, and then the frontend should integrate.
